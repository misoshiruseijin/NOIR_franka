...
class ClientMessage:
    ...
    def queue_request(self):
        ...
        if content_type == "pickle":
            req = {
                "content_bytes" : self._pickle_encode(content, content_encoding),
                "content_type" : content_type,
                "content_encoding" : content_encoding,
            }
        else:
    ...
    def process_response(self):
        ...
        if self.jsonheader["content-type"] == "pickle":
            self.response = self._pickle_decode(data, encoding="")
            print(f"Received pickle response from {self.addr}")
        else:
