...
def get_skill_param(env_name, obj_name, skill_name, world_coords):
...
def collect_data_manual(env_name, save_dir):
    ...
    while True:
        ...
        # get object world coordinates and convert from np arrays to lists (for saving to json)
...
def collect_data_auto(env_name, save_dir):
