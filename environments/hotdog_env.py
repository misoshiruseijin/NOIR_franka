...
class HotDogEnv(RealRobotEnv):
    ...
    def __init__(
        ...
        place_in_bread=False, # if false, task is success after sausage is cooked. if true, task is success after cooked sausage is placed in bread
        use_yaw=True,
        keys=None,
        ...
        self.place_in_bread = place_in_bread 
    ...
    def _check_success(self):
        ...
        if self.place_in_bread:
            success = self.pan_on_stove and self.sausage_cooked and self.sausage_in_bread
        else:
            success = self.pan_on_stove and self.sausage_cooked
    ...
    def _update_keypoints(self):
        ...
        # if not holding anything
            ...
            else: # pan is on stove -> should pick up sausage
                self.keypoints["pick"] = [self.sausage_pos]
                self.keypoints["place"] = []
